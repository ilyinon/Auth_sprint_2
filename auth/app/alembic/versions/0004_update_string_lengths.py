...
def upgrade() -> None:
    ...
    op.alter_column('users', 'username', type_=sa.String(255), existing_type=sa.String(), postgresql_using='username::varchar(50)')
    op.alter_column('users', 'hashed_password', type_=sa.String(255), existing_type=sa.String(), postgresql_using='hashed_password::varchar(128)')
    op.alter_column('users', 'full_name', type_=sa.String(255), existing_type=sa.String(), postgresql_using='full_name::varchar(100)')

    # Update string lengths for UserSocialAccount model
    op.alter_column('user_social_accounts', 'provider', type_=sa.String(255), existing_type=sa.String(), postgresql_using='provider::varchar(50)')
...
def downgrade() -> None:
    ...
    op.alter_column('users', 'username', type_=sa.String(), existing_type=sa.String(255), postgresql_using='username::varchar')
    op.alter_column('users', 'hashed_password', type_=sa.String(), existing_type=sa.String(255), postgresql_using='hashed_password::varchar')
    op.alter_column('users', 'full_name', type_=sa.String(), existing_type=sa.String(255), postgresql_using='full_name::varchar')

    op.alter_column('user_social_accounts', 'provider', type_=sa.String(), existing_type=sa.String(255), postgresql_using='provider::varchar')
